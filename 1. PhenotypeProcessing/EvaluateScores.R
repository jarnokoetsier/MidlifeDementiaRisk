...
# Sample proportion for each factor
...
# Combine value, names, and weight for plotting
...
# CAIDE1 factors: correlation with cell type
...
# ALL risk factors: correlation with cell type
