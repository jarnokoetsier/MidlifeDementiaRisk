...
save(trainResults, file = "CAIDE1_Cor/trainResults_CAIDE1_Cor_EN.RData")
...
save(trainResults, optLambda, optAlpha, perf, finalModel,
     file = paste0("CAIDE1_Cor/CV_CAIDE1_Cor_EN.RData"))
...
save(trainResults, file = "CAIDE1_Cor/trainResults_CAIDE1_Cor_sPLS.RData")
...
save(trainResults, optK, optEta, optKappa, perf, finalModel,
     file ="CAIDE1_Cor/CV_CAIDE1_Cor_sPLS.RData")
...
save(trainResults, file = "CAIDE1_Cor/trainResults_CAIDE1_Cor_RF.RData")
...
save(trainResults, opt_mtry, opt_splitrule, opt_min.node.size, perf, finalModel,
     file ="CAIDE1_Cor/CV_CAIDE1_Cor_RF.RData")
