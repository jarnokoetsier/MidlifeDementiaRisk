...
ggsave(p, file = "CAIDE1_Cat_Cor_AUC_CV.png", height = 5, width = 7.5)
...
ggsave(p, file = "CAIDE1_Cat_Cor_AUC_test.png", height = 5, width = 7.5)
...
ggsave(p, file = "CAIDE1_Cat_Cor_boxPlot_CV.png", height = 5, width = 7.5)
...
ggsave(p, file = "CAIDE1_Cat_Cor_boxPlot_test.png", height = 5, width = 7.5)
