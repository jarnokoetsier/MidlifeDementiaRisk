...
save(trainResults, file = "PGS/trainResults_CAIDE1_CorPGS_EN.RData")
...
save(trainResults, optLambda, optAlpha, perf, finalModel,
     file = "PGS/CV_CAIDE1_CorPGS_EN.RData")
...
RMSE(pred = test, obs = samples_test$CAIDE)
...
save(trainResults, file = "CAIDE1_Cor/trainResults_CAIDE1_CorPGS_sPLS.RData")
...
save(trainResults, optK, optEta, optKappa, perf, finalModel,
     file ="PGS/CV_CAIDE1_CorPGS_sPLS.RData")
...
save(trainResults, file = "PGS/trainResults_CAIDE1_CorPGS_RF.RData")
...
save(trainResults, opt_mtry, opt_splitrule, opt_min.node.size, perf, finalModel,
     file ="PGS/CV_CAIDE1_CorPGS_RF.RData")
