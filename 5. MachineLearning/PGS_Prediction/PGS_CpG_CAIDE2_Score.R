...
save(trainResults, file = "PGS/trainResults_CAIDE2_CorPGS_EN.RData")
...
save(trainResults, optLambda, optAlpha, perf, finalModel,
     file = "PGS/CV_CAIDE2_CorPGS_EN.RData")
...
RMSE(pred = test, obs = samples_test$CAIDE2)
R2(pred = test, obs = samples_test$CAIDE2)
...
save(trainResults, file = "CAIDE2_Cor/trainResults_CAIDE2_CorPGS_sPLS.RData")
...
save(trainResults, optK, optEta, optKappa, perf, finalModel,
     file ="PGS/CV_CAIDE2_CorPGS_sPLS.RData")
...
save(trainResults, file = "PGS/trainResults_CAIDE2_CorPGS_RF.RData")
...
save(trainResults, opt_mtry, opt_splitrule, opt_min.node.size, perf, finalModel,
     file ="PGS/CV_CAIDE2_CorPGS_RF.RData")
