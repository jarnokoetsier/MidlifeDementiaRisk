...
################################################################################
#
# Model training CAIDE2 (EN) -LowRisk
#
################################################################################
...
save(trainResults, file = "trainResults_LowRisk_CAIDE2_Cor_EN.RData")
...
save(trainResults, optLambda, optAlpha, perf, finalModel,
     file = paste0("CV_CAIDE2_Cor_LowRisk_EN.RData"))
...
plot(ifelse(Y_test$CAIDE2 < 5, 2, 1),test[,1])


################################################################################
#
# Model training CAIDE2 (EN) -HighRisk
#
################################################################################

# Class
Y_train$Class <- factor(ifelse(Y_CAIDE1$CAIDE > 8, "High", "Intermediate_Low"),
...
save(trainResults, file = "trainResults_HighRisk_CAIDE2_Cor_EN.RData")
...
# Save data
save(trainResults, optLambda, optAlpha, perf, finalModel,
     file = paste0("CV_CAIDE2_Cor_HighRisk_EN.RData"))


################################################################################
#
# Model training CAIDE2 (sPLSDA) -LowRisk
#
################################################################################
...
save(trainResults, file = "trainResults_LowRisk_CAIDE2_Cor_sPLSDA.RData")
...
save(trainResults, trainResults, optK, optEta, optKappa, perf, finalModel,
     file = paste0("CAIDE2_Cor/CV_CAIDE2_Cor_LowRisk_sPLSDA.RData"))
...
################################################################################
#
# Model training CAIDE2 (sPLSDA) -HighRisk
#
################################################################################
...
save(trainResults, file = "CAIDE2_Cor/trainResults_HighRisk_CAIDE2_Cor_sPLSDA.RData")
...
save(trainResults, optK, optEta, optKappa, perf, finalModel,
     file = paste0("CAIDE1_Cor/CV_CAIDE2_Cor_HighRisk_sPLSDA.RData"))

################################################################################
#
# Model training CAIDE2 (RF) -LowRisk
#
################################################################################
...
Y_train$Class <- factor(ifelse(Y_CAIDE2$CAIDE2 < 5, "Low", "Intermediate_High"),
                        levels = c("Intermediate_High","Low"))
...
save(trainResults, file = "CAIDE2_Cor/trainResults_LowRisk_CAIDE2_Cor_RF.RData")
...
save(trainResults, trainResults, opt_mtry, opt_splitrule, opt_min.node.size, perf, finalModel,
     file = paste0("CAIDE2_Cor/CV_CAIDE2_Cor_LowRisk_RF.RData"))


################################################################################
#
# Model training CAIDE2 (RF) -HighRisk
#
################################################################################
...
Y_train$Class <- factor(ifelse(Y_CAIDE$CAIDE2 > 8, "High", "Low_Intermediate"),
...
save(trainResults, file = "trainResults_HighRisk_CAIDE2_Cor_RF.RData")
...
# Save data
save(trainResults, trainResults, opt_mtry, opt_splitrule, opt_min.node.size, perf, finalModel,
     file = paste0("CAIDE2_Cor/CV_CAIDE2_Cor_HighRisk_RF.RData"))
