...
save(trainResults, file = "LIBRA_Cor/trainResults_LowRisk_LIBRA_Cor_sPLSDA.RData")
...
optPar <- which.max(rowMeans(perf)[!is.na(rowMeans(perf))])
...
# Save data
save(trainResults, optK, optEta, optKappa, perf, finalModel,
     file = paste0("LIBRA_Cor/CV_LIBRA_Cor_HighRisk_sPLSDA.RData"))

################################################################################
#
# Model training LIBRA (RF) -LowRisk
#
################################################################################
...
save(trainResults, file = "LIBRA_Cor/trainResults_LowRisk_LIBRA_Cor_RF.RData")
...
save(trainResults, trainResults, opt_mtry, opt_splitrule, opt_min.node.size, perf, finalModel,
     file = paste0("LIBRA_Cor/CV_LIBRA_Cor_LowRisk_RF.RData"))
...
save(trainResults, file = "LIBRA_Cor/trainResults_HighRisk_LIBRA_Cor_RF.RData")
...
# Save data
save(trainResults, trainResults, opt_mtry, opt_splitrule, opt_min.node.size, perf, finalModel,
     file = paste0("LIBRA_Cor/CV_LIBRA_Cor_HighRisk_RF.RData"))
