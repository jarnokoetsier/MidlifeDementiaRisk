...
# Make predictions (CAIDE1): MRSs + PGSs
...
X_train <- cbind.data.frame(predictedScore_factors[samples_train$Basename,],
                            PGS[samples_train$ID,])
...
# Save model
save(fit, file = "Fit_CombineFactors_EXTEND_EN_PGS.RData")
...
# Save model
save(fit, file = "Fit_CombineFactors_CAIDE1_sPLS_PGS.RData")
...
# Save model
save(fit, file = "Fit_CombineFactors_EXTEND_RF_PGS.RData")
...
# Make predictions (CAIDE2): MRSs + PGSs
...
# Save model
save(fit, file = "Fit_CombineFactors_CAIDE2_EN_PGS.RData")
...
R2(pred = testPred, obs = Y_test$CAID2E)
...
# Save model
save(fit, file = "Fit_CombineFactors_CAIDE2_sPLS_PGS.RData")
...
# Save model
save(fit, file = "Fit_CombineFactors_CAIDE2_RF_PGS.RData")
...
# Make predictions (LIBRA): MRSs + PGSs
...
# Save model
save(fit, file = "Fit_CombineFactors_LIBRA_EN_PGS.RData")
...
# Save model
save(fit, file = "Fit_CombineFactors_LIBRA_RF_PGS.RData")
